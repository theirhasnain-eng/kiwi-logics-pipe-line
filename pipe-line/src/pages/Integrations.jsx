    ...
    <main className="page-section">
      <section className="contact-hero">
        <div className="main">
          <h1>Integrations</h1>
          <p>
            Connect PipelineIQ with the tools your team already uses. 200+
          ...
          <div className="btn">
            ...
            <Link to="/integrations" className="btn-text">
              Integration
            </Link>
          </div>
        </div>
      ...
      <section className="tool" id="tool">
        <div className="text-center">
          ...
          <p className="section-sub">
            From email and calendar to marketing automation and payments,
            PipelineIQ integrates with the tools your team relies on every day.
          </p>
        </div>
              ...
              <div className="tool-main">
                <div className="tool-sub-main">
                  ...
                  <div className="tool-card-submain">
                    <h1>{f.title}</h1>
                    <h4 style={{ backgroundColor: f.color }}>{f.btn}</h4>
                  </div>
                </div>
      ...
      <section className="integration-card">
        <div className="main-sub">
          ...
          <p>
            Our RESTful API and webhooks make it easy to connect PipelineIQ with
            any custom tool or internal system your team uses.
          </p>
          <div className="btn">
            <Link to="/contact" className="intig-btn">
              View API Docs
            </Link>
            <Link to="/contact" className="intig-btn1">
              Talk to Engineering
            </Link>
          </div>
        </div>
      ...
      <section className="integ-hero">
        <div className="main-sub">
          ...
          <p>
            We're constantly adding new integrations. Let us know what tools you
            need and we'll prioritize them.
          </p>
          <div className="btn">
            <Link to="/contact" className="integ-btn">
              Request Integration
            </Link>
          </div>
        </div>
