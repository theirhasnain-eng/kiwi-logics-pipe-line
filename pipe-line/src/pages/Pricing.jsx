      ...
      <section className="contact-hero">
                ...
                <section className='plan'>
                  <div className="plan-main">
                    ...
                    <h5>Start with a 14-day free trial on any plan.
      ...
      <div className="plan-card">
        ...
        <button>
          <Link to="/contact">Contact Sales</Link>
                    ...
                    <p className='main-p'>
                      All plans include unlimited contacts, email sync,
                      and mobile app access. Annual billing saves 20%.
                    </p>
                    </div>
                  </section>
                <FAQ/>
                ...
                <div className="main" id='sale'>
                  ...
                  <div className="btn">
                    ...
                    <Link to="/contact" className="sale-btn1 " id='plan-btn'>Talk to Sales</Link>
                  </div>
                </div>
              </section>  
