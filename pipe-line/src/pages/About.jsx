    ...
    <main className="page-section">
      <section className="contact-hero">
        <div className="main">
          ...
          <p>
            Founded in 2020, we're on a mission to democratize CRM and make
            world-class sales tools accessible to every team.
          </p>
          <div className="btn">
      ...
      <section className="our-mission">
        <div className="mission-main">
          <div className="main-left">
            ...
            <p>
              <span>
                “To build the most intuitive, powerful CRM platform that
                empowers sales teams of every size to close more deals and build
                lasting customer relationships.”
              </span>{" "}
              <br />
              PipelineIQ was founded in 2020 by a team of sales leaders and
              engineers who were frustrated by the complexity and cost of
              existing CRM solutions. We believed that world-class sales tools
              shouldn't require a six-month implementation or a six-figure
              budget.
              <br />
              Today, PipelineIQ powers over 10,000 sales teams worldwide, from
              two-person startups to Fortune 500 enterprises. Our AI-powered
              platform combines the simplicity of modern design with the depth
              of enterprise-grade functionality, helping teams close 40% more
              deals on average.
            </p>
          </div>
      ...
      <section className="value">
        <div className="value-text">
          <h1>Our Values</h1>
          <p>
            The principles that drive every feature we build and every decision
            we make.
          </p>
        </div>
      ...
      <section className="contact-hero">
        <div className="main " id="team">
          ...
          <p>
            ...
            building great products. See our open positions.
          </p>
          <div className="btn">
