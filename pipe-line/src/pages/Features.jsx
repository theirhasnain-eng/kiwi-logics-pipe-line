    ...
    <main className="page-section">
      <section className="contact-hero">
        <div className="main">
          ...
          <p className="pera">
            Discover the powerful tools and capabilities that make PipelineIQ
            the preferred CRM for modern sales teams.
          </p>
          <div className="btn">
            <Link to="/" className="btn-text">
              Home /{" "}
            </Link>
            <Link to="/features" className="btn-text">
              Features
            </Link>
          </div>
        </div>
      ...
      <section className="value " id="deal">
        <div className="value-text">
          ...
          <p className="deal-p">
            PipelineIQ combines AI-powered insights with intuitive design to
            help your sales team work smarter, not harder. From lead capture to
            deal closure, every stage of your pipeline is optimized for success.
          </p>
        </div>

        <div className="features-grid" id="value-grid">
          {deals.map((f, i) => (
            <div key={f.title} className="feature-card reveal value-card">
      ...
      <section className="feature-section">
        <div className="feature-left">
          ...
          <h1>Visual Pipeline That Drives Results</h1>

          <p>
            Drag-and-drop deal management with customizable stages, automated
            workflows, and real-time revenue forecasting that keeps your entire
            team aligned.
          </p>
      ...
      <section className="feature-section sell">
        ...
        <div className="feature-left">
          ...
          <h1>AI That Actually Helps You Sell</h1>

          <p>
            Machine learning models trained on millions of sales interactions to
            predict deal outcomes, recommend next best actions, and score leads
            automatically.
          </p>
      ...
      <section className="feature-section">
        <div className="feature-left">
          ...
          <h1>Personalized Outreach at Scale</h1>

          <p>
            Build multi-step email sequences with dynamic personalization, A/B
            testing, and intelligent send-time optimization to maximize
            engagement.
          </p>
      ...
      <section className="feature-section sell">
        ...
        <div className="feature-left">
          ...
          <h1>Data-Driven Sales Decisions</h1>

          <p>
            Real-time dashboards and custom reports that give you visibility
            into every aspect of your sales performance, from team activity to
            revenue trends.
          </p>
      ...
      <section className="contact-hero">
        <div className="main" id="sale">
          ...
          <p>
            Start your 14-day free trial and see why 10,000+ sales teams trust
            PipelineIQ to close more deals.
          </p>
          <div className="btn">
            <Link to="/pricing" className="sale-btn">
              Start Free Trail
            </Link>
            <Link to="/contact" className="sale-btn1">
              Book a Demo
            </Link>
          </div>
        </div>
